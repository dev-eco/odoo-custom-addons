...
class TestPortalVisibilityFix(TransactionCase):
    def setUp(self):
        ...
        self.portal_b2b_group = self.env.ref(
            "portal_b2b_base.group_portal_b2b_distributor"
        )
    ...
    def test_03_orders_domain_includes_old_orders(self):
        ...
        self.assertIn(
            self.old_order, orders, "El domain debe incluir el pedido antiguo"
        )
    ...
    def test_05_invoice_access_token_generation(self):
        ...
        self.assertTrue(
            invoice.access_token, "Factura debe tener access_token después del fix"
        )
    ...
    def test_07_child_partner_orders_visible(self):
        ...
        self.assertIn(
            child_order, orders, "Pedidos de partners hijos deben ser visibles"
        )
