...
class PortalB2BOverride(CustomerPortal):
    ...
    def my_home_redirect(self, **kw):
        ...
        """
        _logger.info(f"Redirigiendo /my a /mi-portal para usuario {request.env.user.login}")
    ...
    def my_account_redirect(self, **kw):
        ...
        _logger.info(f"Redirigiendo /my/account a /mi-cuenta para usuario {request.env.user.login}")
        return request.redirect('/mi-cuenta', code=301)

    @http.route(['/my/orders', '/my/orders/page/<int:page>'], type='http', auth='user', 
                website=True, sitemap=False, priority=100)
    ...
    @http.route(['/my/invoices', '/my/invoices/page/<int:page>'], type='http', auth='user', 
                website=True, sitemap=False, priority=100)
    ...
    @http.route(['/my/invoices/<int:invoice_id>'], type='http', auth='user', 
                website=True, sitemap=False, priority=100)
