...
class DistributorDashboard(http.Controller):
    ...
    @http.route(
        ["/api/distributor/credit_status"], type="json", auth="user", methods=["POST"]
    )
                ...
                products_data.append(
                    {
                        ...
                        "stock_status_label": dict(
                            product._fields["stock_status"].selection
                        ).get(product.stock_status),
                        "estimated_restock_date": (
                            product.estimated_restock_date.strftime("%d/%m/%Y")
    ...
    @http.route(
        ["/api/distributor/dashboard"], type="json", auth="user", methods=["POST"]
    )
