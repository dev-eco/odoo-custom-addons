...
class PortalAuditLog(models.Model):
    ...
    old_values = fields.Text(
        ...
        help='JSON con valores antes del cambio'
    )
    
    new_values = fields.Text(
        string='Valores Nuevos',
        help='JSON con valores después del cambio'
    )
    ...
    @api.model
    def log_action(self, action, description=None, model_name=None, record_id=None,
