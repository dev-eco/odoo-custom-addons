...
class ProductTemplate(models.Model):
    ...
    def get_stock_info_for_portal(self) -> dict:
        ...
        return {
            ...
            'stock_status_label': dict(self._fields['stock_status'].selection).get(self.stock_status),
            'estimated_restock_date': self.estimated_restock_date.strftime('%d/%m/%Y') if self.estimated_restock_date else None,
            ...
            ] if self.alternative_product_ids else [],
        }
