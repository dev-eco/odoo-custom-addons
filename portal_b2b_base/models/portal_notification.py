...
class PortalNotification(models.Model):
    ...
    action_url = fields.Char(
        string='URL Acción',
        help='URL a la que redirigir al hacer clic'
    )
    ...
    expires_at = fields.Datetime(
        string='Expira',
        help='Fecha de expiración de la notificación'
    )
    ...
    @api.model
    def create_notification(self, partner_id, title, message, notification_type='info', 
                           action_url=None, related_model=None, related_id=None):
        """
