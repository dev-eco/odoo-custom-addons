...
class PortalUserPreferences(models.Model):
    ...
    large_text = fields.Boolean(
        string="Texto Grande", default=False, help="Aumenta el tamaño del texto"
    )
    ...
    language = fields.Selection(
        selection="_get_languages", string="Idioma", default="es_ES"
    )

    timezone = fields.Selection(
        selection="_get_timezones", string="Zona Horaria", default="Europe/Madrid"
    )

    # Notificaciones
    email_notifications = fields.Boolean(
        string="Notificaciones por Email", default=True
    )

    browser_notifications = fields.Boolean(
        string="Notificaciones del Navegador", default=False
    )
    ...
    show_credit_widget = fields.Boolean(
        string="Mostrar Widget de Crédito", default=True
    )
