...
class DistributorLabel(models.Model):
    ...
    customer_address = fields.Text(
        string="Dirección Cliente Final", help="Dirección completa del cliente final"
    )

    customer_phone = fields.Char(string="Teléfono Cliente Final")

    customer_email = fields.Char(string="Email Cliente Final")

    notes = fields.Text(string="Notas", help="Información adicional sobre este cliente")
    ...
    transport_label_filename = fields.Char(string="Nombre Archivo Etiqueta")
    ...
    delivery_note_filename = fields.Char(string="Nombre Archivo Albarán")
        ...
        for label in self:
            ...
            if orders:
                ...
                label.last_order_date = (
                    latest_order.date_order.date() if latest_order.date_order else False
                )
            else:
